<x-app-layout>
    ...
    <!-- Page Content -->
            <x-auth-card>
                <x-slot name="logo">
                    Check all attributes you want to include in your Sample Sorting (SS) experiment
                    <br>
            ...
            {!! Form::model( $pc, [ 'route' => array( 'export_sss', 'pc' => $pc ), 'method' => 'POST' ] ) !!}
            ...
            <!-- PROJECT CODE (PC) -->
                ...
                <div class="flex items-center justify-end mt-4">
                    <a class="underline text-sm text-gray-600 hover:text-gray-900" href="{{ route('sss.index', ['pt'=>$pt]) }}">
