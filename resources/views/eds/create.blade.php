<x-app-layout>
    ...
    <!-- Page Content -->
            ...
            <x-auth-card>
                <x-slot name="logo">
                    Check all attributes you want to include in your experiment
                    <br>
            ...
            {!! Form::model( $project, [ 'route' => [ 'export_eds', ], 'method' => 'POST'] ) !!}
            ...
            <!-- FORM TYPE (FT) code in conflict with Finish Time (FT) code
                ...
                <!-- Indoor/Outdoor (IN) -->
                <div>
                    {{ Form::label( 'in', 'Indoor/Outdoor (IN)', [ 'class'=>' bg-red-300 ', ] ) }}
                    {{ Form::checkbox( 'in', old( 'in' ), true, [ 'required'=> true, ] ) }}
                </div>
                <br>
                ...
                <!-- Start Time (ST) -->
                <div>
                    {{ Form::label( 'st', 'Start Time (ST)', [ 'class'=>' bg-red-300 ', ] ) }}
                ...
                <!-- Finish Time (FT) -->
                <div>
                    {{ Form::label( 'ft', 'Finish Time (FT)', [ 'class'=>' bg-red-300 ', ] ) }}
                    {{ Form::checkbox( 'ft', old( 'ft' ), true, [ 'required'=> true, ]  ) }}
                </div>
                <br>
                ...
                <!-- Valid Catch (VC) -->
                <div>
                    {{ Form::label( 'vc', 'Valid Catch (VC)', [ 'class'=>' bg-red-300 ', ] ) }}
                    {{ Form::checkbox( 'vc', old( 'vc' ), true, [ 'required'=> true, ] ) }}
                </div>
                <br>

                <!-- SS Form Serial No. (DSEN) -->
                <div>
                    {{ Form::label( 'dsen', 'SS Form Serial No. (DSEN)', [ 'class'=>' bg-red-300 ', ] ) }}
